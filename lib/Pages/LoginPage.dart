        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              RichText(
                text: TextSpan(
                  style: GoogleFonts.cormorantGaramond(fontSize: 70, fontWeight: FontWeight.w600, color: _ink, height: 1.2),
                  children: const [
                    // TextSpan(text: 'Welcome\n'),
                    TextSpan(text: 'Login,', style: TextStyle(fontStyle: FontStyle.italic, color: _gold)),
                  ],
                ),
              ),
              ...
              Text('Sign in to continue your reading journey.',
                style: GoogleFonts.outfit(fontSize: 18, color: _muted, height: 1.5, fontStyle: FontStyle.italic)),
                  
              const SizedBox(height: 48),

              // ── Fields ──
              const _Field(hint: 'Email address', icon: Icons.mail_outline_rounded),
              const SizedBox(height: 18),
              const _Field(hint: 'Password', icon: Icons.lock_outline_rounded, obscure: true),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Sign in',
                    style: GoogleFonts.outfit(fontSize: 16, fontWeight: FontWeight.w600, color: _bg)),
                ),
              ),
              ...
              Row(children: [
                ...
                Padding(
                  ...
                  child: Text('or', style: GoogleFonts.outfit(fontSize: 13, color: _muted)),
                ),
                const Expanded(child: Divider(color: Color(0xFF2A2520))),
              ]),
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  onPressed: () {},
                  icon: const Text('G', style: TextStyle(fontSize: 18, color: _ink, fontWeight: FontWeight.w700)),
